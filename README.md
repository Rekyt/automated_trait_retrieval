...
`ritalic`         | https://cran.r-project.org/package=ritalic        | https://github.com/plant-data/ritalic                                                       | lichens                           | Access the [ITALIC database (ITAlian LIChens)](https://italic.units.it/), through its API
